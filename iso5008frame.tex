...
\AddToShipoutPicture*{%
  ...
  \AtPageUpperLeft{%
	...
	\AtTextCenter{
	%  \put(0mm,-40mm){%
	%    \textcolor{blue!25}{\circle*{.5\textwidth}}}%
	}%
	\AtPageLowerLeft{%
	%\multiput(startH, startV)(Vector? .01\paperwidth,0){laenge(in %?) 100}{zeichenrichtung der punkte \line(1,0){ punktierungslaenge .005\paperwidth}}
	%\multiput(0,10mm)(.01\paperwidth,0){50}{\line(1,0){.001\paperwidth}}%
	%\put(horziontaler start,vertikaler start){\vector(0,1){seitenlaenge 10cm}}%
	%\put(.1\paperwidth,.1\paperwidth){\vector(1,1){10cm}}%
